...
class ExpedientesController extends Controller
{
    ...
    public function actionIndexList($request){
        ...
        // $modelExpedientes =  GaArchivo::find();
        // $modelExpedientes = HelperQueryDb::getQuery('rightJoin', $modelExpedientes, 'gdExpedientes', ['gdExpedientes' => 'idGdExpediente', 'gaArchivo' => 'idGdExpediente'])
        // ->select(['gdExpedientes.idGdExpediente','gdExpedientes.nombreGdExpediente','gdExpedientes.numeroGdExpediente', 'gaArchivo.idGaEdificio'])
        // ->where(['gdExpedientes.estadoGdExpediente' => Yii::$app->params['statusTodoText']['Activo']])
        // ->andWhere(['gdExpedientes.idGdTrdDependencia' => $idDependencia]);
