...
-- Tiempo de generación: 31-01-2023 a las 22:07:17
...
CREATE TABLE `cgFormulariosPqrsDetalleDocumentos` (
  ...
  `nameFileCgFormulariosPqrsDetalleDocumentos` varchar(255) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='configuración tiempos de respuesta ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Tabla de configuración de plantillas';
...
CREATE TABLE `gdExpedienteDocumentos` (
  ...
  `idUser` int(11) NOT NULL,
  `nombreGdExpedienteDocumento` varchar(80) DEFAULT NULL,
...
CREATE TABLE `gdExpedientes` (
  ...
  `nombreGdExpediente` varchar(80) NOT NULL COMMENT 'Nombre del expediente',
...
CREATE TABLE `gdIndices` (
  ...
  `nombreDocumentoGdIndice` varchar(80) NOT NULL COMMENT 'Nombre del documento',
  ...
  `usuarioGdIndice` varchar(80) NOT NULL COMMENT 'Usuario que anexó el documento',
...
CREATE TABLE `gdTrdSeries` (
  ...
  `nombreGdTrdSerie` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `codigoGdTrdSerie` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `gdTrdSubseries` (
  ...
  `nombreGdTrdSubserie` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre de la subserie documental',
  `codigoGdTrdSubserie` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Código asociado a la subserie documetal este va a sociado a la dependencia',
  ...
  `procedimientoGdTrdSubserie` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Procedimiento correspondiente a la subserie',
  ...
  `normaGdTrdSubserie` text COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Guarda la norma que justifica la subserie',
...
CREATE TABLE `gdTrdSubseriesTmp` (
  ...
  `normaGdTrdSubserieTmp` text COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `gdTrdTiposDocumentales` (
  ...
  `nombreTipoDocumental` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `log` (
  ...
  `antesLog` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `despuesLog` text COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `rolesTipoRadicado` (
  ...
  `idCgTipoRadicado` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Relación Roles y Tipo de Radicado';
...
CREATE TABLE `csInicial` (
  ...
  `estadoCsInicial` smallint NOT NULL DEFAULT '10'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ;
...
CREATE TABLE `csParams` (
  ...
  `estadoCsParams` smallint NOT NULL DEFAULT '10'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ;
...
--
ALTER TABLE `csInicial`
  MODIFY `idCsInicial` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `csParams`
--
ALTER TABLE `csParams`
  MODIFY `idCsParams` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `cgFormulariosPqrsDetalleDocumentos`
--
ALTER TABLE `cgFormulariosPqrsDetalleDocumentos`
  MODIFY `idCgFormulariosPqrsDetalleDocumentos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
...
ALTER TABLE `user` ADD `licenciaAceptada` SMALLINT NOT NULL DEFAULT '0' COMMENT 'Indica si el usuario acepta o no la licencia que ofrece el software' AFTER `idGdTrdDependencia`;
ALTER TABLE `gdExpedienteDocumentos` CHANGE `nombreGdExpedienteDocumento` `nombreGdExpedienteDocumento` VARCHAR(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL;
ALTER TABLE `gdExpedientes` CHANGE `nombreGdExpediente` `nombreGdExpediente` VARCHAR(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'Nombre del expediente';
ALTER TABLE `gdIndices` CHANGE `nombreDocumentoGdIndice` `nombreDocumentoGdIndice` VARCHAR(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'Nombre del documento';
